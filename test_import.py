...
for txn in qif.get_transactions()[0]:  # [0] = premier compte
    ...
    o = Operation(date_operation,type,"",tiers_id[payee] if tiers_id[payee] else None,"",cat if cat is not None else "",subcat if subcat is not None else "",debit,credit,memo,'686c2148052a697aa967876a',bq = 1,beneficiaire='',type_beneficiaire="")
